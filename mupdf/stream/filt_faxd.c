...
enum {
    ...
    SH1,
    SH2 /* in H part 1 and 2 (both makeup and terminating codes) */
};
...
fz_error* fz_newfaxd(fz_filter** fp, fz_obj* params)
{
    fz_obj* obj;
...
static int getcode(fz_faxd* fax, const cfd_node* table, int initialbits)
{
...
/* decode one 1d code */
static fz_error* dec1d(fz_faxd* fax)
{
    int code;
...
/* decode one 2d code */
static fz_error* dec2d(fz_faxd* fax)
{
    int code, b1, b2;
...
fz_error* fz_processfaxd(fz_filter* f, fz_buffer* in, fz_buffer* out)
{
