...
fz_error* fz_newjbig2d(fz_filter** fp, fz_obj* params)
{
...
void fz_dropjbig2d(fz_filter* filter)
{
...
fz_error* fz_processjbig2d(fz_filter* filter, fz_buffer* in, fz_buffer* out)
{
    fz_jbig2d* d = (fz_jbig2d*)filter;
    int        len;
    int        i;
