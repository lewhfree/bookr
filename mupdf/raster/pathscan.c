...
fz_error* fz_insertgel(fz_gel* gel, float fx0, float fy0, float fx1, float fy1)
{
    fz_edge* edge;
    int      x0, y0, x1, y1;
    int      dx, dy;
...
static inline void sortael(fz_edge** a, int n)
{
    int      h, i, k;
    fz_edge* t;
...
static fz_error* insertael(fz_ael* ael, fz_gel* gel, int y, int* e)
{
...
static void advanceael(fz_ael* ael)
{
    fz_edge* edge;
    int      i = 0;
...
static inline void addspan(unsigned char* list, int x0, int x1, int xofs, int hs)
{
    int x0pix, x0sub;
    int x1pix, x1sub;
...
static inline void nonzerowinding(fz_ael* ael, unsigned char* list, int xofs, int hs)
{
    int winding = 0;
    int x       = 0;
    int i;
...
static inline void evenodd(fz_ael* ael, unsigned char* list, int xofs, int hs)
{
    int even = 0;
    int x    = 0;
    int i;
...
static inline void blit(fz_pixmap* pix, int x, int y, unsigned char* list, int skipx, int len, unsigned char* rgb, int over)
{
    unsigned char* dst;
    int            cov;
...
fz_error* fz_scanconvert(fz_gel* gel, fz_ael* ael, int eofill, fz_irect clip, fz_pixmap* pix, unsigned char* rgb, int over)
{
    fz_error*      error;
