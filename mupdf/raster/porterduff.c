...
/* dst = src over dst */
static void duff_non(byte* sp0, int sw, int sn, byte* dp0, int dw, int w0, int h)
{
    int k;
    while (h--) {
        byte* sp = sp0;
...
/* dst = src in msk */
static void duff_nimcn(byte* sp0, int sw, int sn, byte* mp0, int mw, int mn, byte* dp0, int dw, int w0, int h)
{
    int k;
    while (h--) {
        byte* sp = sp0;
...
static void duff_nimon(byte* sp0, int sw, int sn, byte* mp0, int mw, int mn, byte* dp0, int dw, int w0, int h)
{
    int k;
    while (h--) {
        byte* sp = sp0;
