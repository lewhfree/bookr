...
#define FZ_PSRC unsigned char *src, int srcw, int srch
#define FZ_PDST unsigned char *dst0, int dstw
#define FZ_PCTM int u0, int v0, int fa, int fb, int fc, int fd, int w0, int h
