...
#define FT_DEFINE_PSHINTER_INTERFACE(class_, get_globals_funcs_, get_t1_funcs_, get_t2_funcs_) static const PSHinter_Interface class_ = {get_globals_funcs_, get_t1_funcs_, get_t2_funcs_};
