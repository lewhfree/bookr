...
#define FT_FRAME_FIELD(frame_op, field) {frame_op, FT_FIELD_SIZE(field), FT_FIELD_OFFSET(field)}
...
#define FT_FRAME_BYTES(field, count) {ft_frame_bytes, count, FT_FIELD_OFFSET(field)}
