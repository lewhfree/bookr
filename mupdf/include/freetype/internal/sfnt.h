 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Load_Svg_Doc_Func)(FT_GlyphSlot glyph, FT_UInt glyph_index);
 ...
 */
typedef FT_Bool (*TT_Get_Color_Glyph_Paint_Func)(TT_Face face, FT_UInt base_glyph, FT_Color_Root_Transform root_transform, FT_OpaquePaint* paint);
 ...
 */
typedef FT_Bool (*TT_Get_Color_Glyph_ClipBox_Func)(TT_Face face, FT_UInt base_glyph, FT_ClipBox* clip_box);
 ...
 */
typedef FT_Bool (*TT_Get_Paint_Layers_Func)(TT_Face face, FT_LayerIterator* iterator, FT_OpaquePaint* paint);
 ...
 *   also.
 */
typedef FT_Bool (*TT_Get_Colorline_Stops_Func)(TT_Face face, FT_ColorStop* color_stop, FT_ColorStopIterator* iterator);
 ...
 */
typedef FT_Bool (*TT_Get_Paint_Func)(TT_Face face, FT_OpaquePaint opaque_paint, FT_COLR_Paint* paint);
...
#define FT_DEFINE_SFNT_INTERFACE(class_, goto_table_, init_face_, load_face_, done_face_, get_interface_, load_any_, load_head_, load_hhea_, load_cmap_, load_maxp_, load_os2_, load_post_, load_name_, free_name_, \
                                 load_kern_, load_gpos_, load_gasp_, load_pclt_, load_bhed_, load_sbit_image_, get_psname_, free_psnames_, get_kerning_, get_gpos_kerning_, load_font_dir_, load_hmtx_, load_eblc_, \
                                 free_eblc_, set_sbit_strike_, load_strike_metrics_, load_cpal_, load_colr_, free_cpal_, free_colr_, set_palette_, get_colr_layer_, get_colr_glyph_paint_, get_color_glyph_clipbox, \
                                 get_paint_layers_, get_colorline_stops_, get_paint_, colr_blend_, get_metrics_, get_name_, get_name_id_, load_svg_, free_svg_, load_svg_doc_)                                      \
