...
#define FT_DEBUG_INNER(exp) (ft_debug_file_ = __FILE__, ft_debug_lineno_ = __LINE__, (exp))

#define FT_ASSIGNP_INNER(p, exp) (ft_debug_file_ = __FILE__, ft_debug_lineno_ = __LINE__, FT_ASSIGNP(p, exp))
...
#define FT_MEM_REALLOC_MULT(ptr, oldcnt, newcnt, itmsz) FT_ASSIGNP_INNER(ptr, ft_mem_realloc(memory, (FT_Long)(itmsz), (FT_Long)(oldcnt), (FT_Long)(newcnt), (ptr), &error))
...
#define FT_MEM_QREALLOC_MULT(ptr, oldcnt, newcnt, itmsz) FT_ASSIGNP_INNER(ptr, ft_mem_qrealloc(memory, (FT_Long)(itmsz), (FT_Long)(oldcnt), (FT_Long)(newcnt), (ptr), &error))
...
#define FT_QNEW_ARRAY(ptr, count) FT_MEM_SET_ERROR(FT_MEM_QNEW_ARRAY(ptr, count))

#define FT_QRENEW_ARRAY(ptr, curcnt, newcnt) FT_MEM_SET_ERROR(FT_MEM_QRENEW_ARRAY(ptr, curcnt, newcnt))
