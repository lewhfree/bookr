...
#define FT_DEFINE_CMAP_CLASS(class_, size_, init_, done_, char_index_, char_next_, char_var_index_, char_var_default_, variant_list_, charvariant_list_, variantchar_list_) \
    ...
    const FT_CMap_ClassRec class_ = {size_, init_, done_, char_index_, char_next_, char_var_index_, char_var_default_, variant_list_, charvariant_list_, variantchar_list_};
 ...
 *   used).
 */
#define FT_DEFINE_OUTLINE_FUNCS(class_, move_to_, line_to_, conic_to_, cubic_to_, shift_, delta_) static const FT_Outline_Funcs class_ = {move_to_, line_to_, conic_to_, cubic_to_, shift_, delta_};
...
#define FT_DEFINE_RENDERER(class_, flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_, glyph_format_, render_glyph_, transform_glyph_, get_glyph_cbox_, set_mode_, raster_class_) \
    FT_CALLBACK_TABLE_DEF                                                                                                                                                                                          \
    const FT_Renderer_Class class_ = {FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_) glyph_format_,                                                    \
                                                                                                                                                                                                                   \
                                      render_glyph_,                                                                                                                                                               \
                                      transform_glyph_,                                                                                                                                                            \
                                      get_glyph_cbox_,                                                                                                                                                             \
