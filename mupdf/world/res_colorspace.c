...
void fz_convertpixmap(fz_colorspace* srcs, fz_pixmap* src, fz_colorspace* dsts, fz_pixmap* dst) { srcs->convpixmap(srcs, src, dsts, dst); }

void fz_convertcolor(fz_colorspace* srcs, float* srcv, fz_colorspace* dsts, float* dstv) { srcs->convcolor(srcs, srcv, dsts, dstv); }
...
void fz_stdconvpixmap(fz_colorspace* srcs, fz_pixmap* src, fz_colorspace* dsts, fz_pixmap* dst)
{
