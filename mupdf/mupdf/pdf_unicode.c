...
static fz_error* addtextchar(pdf_textline* line, fz_irect bbox, int c)
{
...
static fz_error* extracttext(pdf_textline** line, fz_node* node, fz_matrix ctm)
{
    fz_error* error;
...
fz_error* pdf_loadtextfromtree(pdf_textline** outp, fz_tree* tree, fz_matrix ctm)
{
    pdf_textline* root;
    pdf_textline* line;
    fz_error*     error;
