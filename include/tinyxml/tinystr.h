...
public:
    ...
    size_t length() const { return (allocated) ? current_length : 0; }
...
protected:
    ...
    // we need
    size_t assign_new_size(size_t minimum_to_allocate) { return minimum_to_allocate * 2; }
    ...
    void append(const TiXmlString& suffix) { append(suffix.c_str()); }
