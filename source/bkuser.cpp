...
void BKUser::load()
{
    ...
    if (controls != 0) {
        ...
        while (bind) {
            ...
            int b = atoi(button);
            if (strncmp(action, "controls.previousPage", 128) == 0)
                BKUser::controls.previousPage = b;
            else if (strncmp(action, "controls.nextPage", 128) == 0)
                BKUser::controls.nextPage = b;
            else if (strncmp(action, "controls.previous10Pages", 128) == 0)
                BKUser::controls.previous10Pages = b;
            else if (strncmp(action, "controls.next10Pages", 128) == 0)
                BKUser::controls.next10Pages = b;
            else if (strncmp(action, "controls.screenUp", 128) == 0)
                BKUser::controls.screenUp = b;
            else if (strncmp(action, "controls.screenDown", 128) == 0)
                BKUser::controls.screenDown = b;
            else if (strncmp(action, "controls.screenLeft", 128) == 0)
                BKUser::controls.screenLeft = b;
            else if (strncmp(action, "controls.screenRight", 128) == 0)
                BKUser::controls.screenRight = b;
            else if (strncmp(action, "controls.zoomIn", 128) == 0)
                BKUser::controls.zoomIn = b;
            else if (strncmp(action, "controls.zoomOut", 128) == 0)
                BKUser::controls.zoomOut = b;
    ...
    if (eoptions != 0) {
        ...
        while (eset) {
            ...
            } else if (strncmp(option, "txtSize", 128) == 0)
                options.txtSize = atoi(value);
            else if (strncmp(option, "txtHeightPct", 128) == 0)
                options.txtHeightPct = atoi(value);
            else if (strncmp(option, "txtSize", 128) == 0)
                options.txtSize = atoi(value);
            ...
            } else if (strncmp(option, "currentScheme", 128) == 0)
                options.currentScheme = atoi(value);
            else if (strncmp(option, "pspSpeed", 128) == 0)
                options.pspSpeed = atoi(value);
            else if (strncmp(option, "pspMenuSpeed", 128) == 0)
                options.pspMenuSpeed = atoi(value);
            else if (strncmp(option, "displayLabels", 128) == 0)
                options.displayLabels = atoi(value) != 0;
            else if (strncmp(option, "pdfInvertColors", 128) == 0)
                options.pdfInvertColors = atoi(value) != 0;
            else if (strncmp(option, "lastFolder", 128) == 0)
                options.lastFolder = value;
            else if (strncmp(option, "lastFontFolder", 128) == 0)
                options.lastFontFolder = value;
            else if (strncmp(option, "loadLastFile", 128) == 0)
                options.loadLastFile = atoi(value) != 0;
            else if (strncmp(option, "txtWrapCR", 128) == 0)
                options.txtWrapCR = atoi(value);
