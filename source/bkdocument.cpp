...
BKDocument::BKDocument() : mode(BKDOC_VIEW), bannerFrames(0), banner(""), tipFrames(120), toolbarSelMenu(0), toolbarSelMenuItem(0), frames(0) { lastSuspendSerial = FZScreen::getSuspendSerial(); }
...
void BKDocument::render()
{
    ...
    if (tipFrames > 0 && mode != BKDOC_TOOLBAR) {
        ...
        if (alpha > 0) {
            ...
            drawPill(480 - 37 - 37 - 8, 272 - 18 - 4, 37 * 2 + 2, 50, 6, 31, 1);
            FZScreen::ambientColor(0xffffff | (alpha << 24));
            drawImage(480 - 37 - 2, 272 - 18, 37, 18, 75, 60);
            drawImage(480 - 37 - 2 - 2 - 37, 272 - 18, 37, 18, 75, 39);
        }
    }
    ...
    drawPill(25 + toolbarSelMenu * 55, 272 - 156 - cs * 35 + 70, 40, cs * 35 + 45, 6, 31, 1);
    ...
    if (iw < mw)
        iw = mw;
    int selItemI = overflow ? toolbarSelMenuItem > 4 ? 4 : toolbarSelMenuItem : toolbarSelMenuItem;
    drawPill(30 + toolbarSelMenu * 55, 272 - 156 - selItemI * 35 + 40, iw + 10 + 35, 30, 6, 31, 1);
    ...
    for (int i = init, j = 0; i < ts; i++, j++) {
        ...
        if (i == toolbarSelMenuItem)
            ...
            FZScreen::ambientColor(0xffffffff);
        if (it2.iconW > 0)
            drawImage(40 + toolbarSelMenu * 55, 272 - 156 - j * 35 + 45, it2.iconW, it2.iconH, it2.iconX, it2.iconY);
    }
