...
enum { MINBITS = 9, MAXBITS = 12, NUMCODES = (1 << MAXBITS), LZW_CLEAR = 256, LZW_EOD = 257, LZW_FIRST = 258 };
...
fz_error* fz_newlzwd(fz_filter** fp, fz_obj* params)
{
    int i;
...
void fz_droplzwd(fz_filter* filter) {}
...
fz_error* fz_processlzwd(fz_filter* filter, fz_buffer* in, fz_buffer* out)
{
