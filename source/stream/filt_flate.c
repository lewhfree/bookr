...
fz_error* fz_newflated(fz_filter** fp, fz_obj* params)
{
    fz_error* eo;
    fz_obj*   obj;
    int       zipfmt;
...
void fz_dropflated(fz_filter* f)
{
...
fz_error* fz_processflated(fz_filter* f, fz_buffer* in, fz_buffer* out)
{
    z_streamp zp = &((fz_flate*)f)->z;
    int       err;
...
fz_error* fz_newflatee(fz_filter** fp, fz_obj* params)
{
    fz_obj*   obj;
    fz_error* eo;
    int       effort;
...
void fz_dropflatee(fz_filter* f)
{
    z_streamp zp = &((fz_flate*)f)->z;
    int       err;
...
fz_error* fz_processflatee(fz_filter* f, fz_buffer* in, fz_buffer* out)
{
    z_streamp zp = &((fz_flate*)f)->z;
    int       err;
