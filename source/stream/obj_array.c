...
fz_error* fz_copyarray(fz_obj** op, fz_obj* obj)
{
    fz_error* error;
    fz_obj* new;
    int i;
...
fz_error* fz_deepcopyarray(fz_obj** op, fz_obj* obj)
{
    fz_error* error;
    fz_obj* new;
    fz_obj* val;
...
fz_obj* fz_arrayget(fz_obj* obj, int i)
{
    if (!fz_isarray(obj))
        return nil;
...
fz_error* fz_arrayput(fz_obj* obj, int i, fz_obj* item)
{
    if (!fz_isarray(obj))
...
static fz_error* growarray(fz_obj* obj)
{
    fz_obj** newitems;
    int      newcap;
    int      i;
...
fz_error* fz_arraypush(fz_obj* obj, fz_obj* item)
{
    fz_error* error;
