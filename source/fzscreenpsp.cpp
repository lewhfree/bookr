...
void FZScreen::close() { sceGuTerm(); }

void FZScreen::exit() { sceKernelExitGame(); }
...
void FZScreen::startDirectList() { sceGuStart(GU_DIRECT, list); }
...
void FZScreen::waitVblankStart() { sceDisplayWaitVblankStart(); }

void* FZScreen::getListMemory(int s) { return sceGuGetMemory(s); }

void FZScreen::shadeModel(int mode) { sceGuShadeModel(mode); }

void FZScreen::color(unsigned int c) { sceGuColor(c); }

void FZScreen::ambientColor(unsigned int c) { sceGuAmbientColor(c); }
...
void FZScreen::copyImage(int psm, int sx, int sy, int width, int height, int srcw, void* src, int dx, int dy, int destw, void* dest) { sceGuCopyImage(psm, sx, sy, width, height, srcw, src, dx, dy, destw, dest); }

void* FZScreen::framebuffer() { return lastFramebuffer; }

void FZScreen::blendFunc(int op, int src, int dst) { sceGuBlendFunc(op, src, dst, 0, 0); }

void FZScreen::enable(int m) { sceGuEnable(m); }

void FZScreen::disable(int m) { sceGuDisable(m); }

void FZScreen::dcacheWritebackAll() { sceKernelDcacheWritebackAll(); }
...
int FZScreen::getSuspendSerial() { return powerResumed; }
...
int FZScreen::getSpeed() { return scePowerGetCpuClockFrequency(); }
