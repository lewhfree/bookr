...
FZImage::Format FZImage::getFormat() const { return imageFormat; }
...
char* FZImage::getData() { return data; }

unsigned int* FZImage::getCLUT() { return clut; }

unsigned int FZImage::getCLUTSize() { return clutSize; }
