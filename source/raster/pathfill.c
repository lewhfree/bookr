...
static fz_error* line(fz_gel* gel, fz_matrix* ctm, float x0, float y0, float x1, float y1)
{
...
static fz_error* bezier(fz_gel* gel, fz_matrix* ctm, float flatness, float xa, float ya, float xb, float yb, float xc, float yc, float xd, float yd)
{
    fz_error* error;
    float     dmax;
    float     xab, yab;
