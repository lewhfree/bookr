...
static void loadtile2(byte* src, int sw, byte* dst, int dw, int w, int h, int pad) TILE(ttwo) static void loadtile4(byte* src, int sw, byte* dst, int dw, int w, int h, int pad)
    TILE(tnib) static void loadtile8(byte* src, int sw, byte* dst, int dw, int w, int h, int pad) TILE(toct)
