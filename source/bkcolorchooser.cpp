...
BKColorChooser::~BKColorChooser() { hueTex->release(); }

unsigned int BKColorChooser::getColor() { return color; }
...
void BKColorChooser::render()
{
    ...
    case BK_CMD_SET_TXTFG:
        title = "Select text color (plain text only)";
        break;
    case BK_CMD_SET_TXTBG:
        title = "Select background color (plain text and PDF)";
        break;
    default:
        break;
    }
    ...
    C8888V32F2D vertices[18] = {
        {hueColor, x, y, 0},          {hueColor, x + side, y, 0},
        {0xffffffff, x, y + side, 0},

        {hueColor, x + side, y, 0},   {0xffffffff, x + side, y + side, 0},
        {0xffffffff, x, y + side, 0},

        {0xff000000, x, y, 0},        {0x00000000, x + side, y, 0},
        {0xff000000, x, y + side, 0},

        {0x00000000, x + side, y, 0}, {0x00000000, x + side, y + side, 0},
        {0xff000000, x, y + side, 0},

        {color, 300, y2, 0},          {color, 400, y2, 0},
        {color, 300, y2 + side2, 0},

        {color, 400, y2, 0},          {color, 400, y2 + side2, 0},
        {color, 300, y2 + side2, 0},
    };
...
BKColorChooser* BKColorChooser::create(int cs, int re)
{
    ...
    switch (re) {
    case BK_CMD_SET_TXTFG:
        c = BKUser::options.colorSchemes[cs].txtFGColor;
        break;
    case BK_CMD_SET_TXTBG:
    default:
        c = BKUser::options.colorSchemes[cs].txtBGColor;
        break;
    }
