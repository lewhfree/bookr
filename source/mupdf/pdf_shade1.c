...
fz_error* pdf_loadtype1shade(fz_shade* shade, pdf_xref* xref, fz_obj* dict, fz_obj* ref)
{
    fz_error*     error;
    fz_obj*       obj;
    fz_matrix     matrix;
...
fz_error* pdf_loadtype2shade(fz_shade* shade, pdf_xref* xref, fz_obj* dict, fz_obj* ref)
{
...
static int buildannulusmesh(float* mesh, int pos, float x0, float y0, float r0, float x1, float y1, float r1, float c0, float c1, int nomesh)
{
    int   n    = pos * 3;
...
fz_error* pdf_loadtype3shade(fz_shade* shade, pdf_xref* xref, fz_obj* shading, fz_obj* ref)
{
    fz_obj* obj;
