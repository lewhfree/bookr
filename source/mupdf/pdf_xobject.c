...
fz_error* pdf_loadxobject(pdf_xobject** formp, pdf_xref* xref, fz_obj* dict, fz_obj* ref)
{
    fz_error*    error;
    pdf_xobject* form;
    fz_obj*      obj;
    ...
    pdf_logrsrc("bbox [%g %g %g %g]\n", form->bbox.x0, form->bbox.y0, form->bbox.x1, form->bbox.y1);
    ...
    pdf_logrsrc("matrix [%g %g %g %g %g %g]\n", form->matrix.a, form->matrix.b, form->matrix.c, form->matrix.d, form->matrix.e, form->matrix.f);
