...
static fz_error* preloadcolorspace(pdf_xref* xref, fz_obj* ref)
{
    fz_error*      error;
...
static fz_error* preloadpattern(pdf_xref* xref, fz_obj* ref)
{
    fz_error*    error;
    pdf_pattern* pattern;
    fz_shade*    shade;
...
static fz_error* preloadshading(pdf_xref* xref, fz_obj* ref)
{
    fz_error* error;
    fz_shade* shade;
    fz_obj*   obj = ref;
...
static fz_error* preloadxobject(pdf_xref* xref, fz_obj* ref)
{
    fz_error*    error;
    pdf_xobject* xobject;
    pdf_image*   image;
...
static fz_error* preloadfont(pdf_xref* xref, fz_obj* ref)
{
    fz_error* error;
    pdf_font* font;
    fz_obj*   obj = ref;
...
static fz_error* scanfonts(pdf_xref* xref, fz_obj* rdb)
{
    fz_error* error;
    fz_obj*   dict;
    fz_obj*   obj;
...
static fz_error* copyresolved(fz_obj** outp, pdf_xref* xref, fz_obj* dict)
{
    fz_error* error;
    fz_obj *  key, *val, *obj;
    fz_obj*   copy;
...
fz_error* pdf_loadresources(fz_obj** rdbp, pdf_xref* xref, fz_obj* orig)
{
    fz_error* error;
    fz_obj*   copy;
    fz_obj*   old;
