...
static fz_error* runone(pdf_csi* csi, pdf_xref* xref, fz_obj* rdb, fz_obj* stmref)
{
    fz_error*  error;
    fz_stream* stm;
 ...
 */
static fz_error* runmany(pdf_csi* csi, pdf_xref* xref, fz_obj* rdb, fz_obj* list)
{
    fz_error*  error;
    fz_stream* file;
    fz_buffer* big;
...
static fz_error* loadpagecontents(fz_tree** treep, pdf_xref* xref, fz_obj* rdb, fz_obj* ref)
{
    fz_error* error;
    fz_obj*   obj;
    pdf_csi*  csi;
...
fz_error* pdf_loadpage(pdf_page** pagep, pdf_xref* xref, fz_obj* dict)
{
    fz_error*    error;
    fz_obj*      obj;
    pdf_page*    page;
