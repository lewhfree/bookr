 ...
 */
static fz_error* buildonefilter(fz_filter** fp, fz_obj* f, fz_obj* p)
{
 ...
 */
static fz_error* buildfilterchain(fz_filter** filterp, fz_filter* head, fz_obj* fs, fz_obj* ps)
{
    fz_error*  error;
    fz_filter* newhead;
    fz_filter* tail;
 ...
 */
static fz_error* buildrawfilter(fz_filter** filterp, pdf_xref* xref, fz_obj* stmobj, int oid, int gen)
{
    fz_error*  error;
    fz_filter* base;
    fz_obj*    stmlen;
 ...
 */
static fz_error* pdf_buildfilter(fz_filter** filterp, pdf_xref* xref, fz_obj* stmobj, int oid, int gen)
{
    fz_error*  error;
 ...
 */
fz_error* pdf_openrawstream(fz_stream** stmp, pdf_xref* xref, int oid, int gen)
{
    pdf_xrefentry* x;
    fz_error*      error;
    fz_filter*     filter;
 ...
 */
fz_error* pdf_openstream(fz_stream** stmp, pdf_xref* xref, int oid, int gen)
{
    pdf_xrefentry* x;
    fz_error*      error;
    fz_stream*     rawstm;
