...
BKFileChooser::~BKFileChooser() { BKUser::save(); }

void BKFileChooser::getCurrentDirent(FZDirent& de) { de = dirFiles[selItem]; }

void BKFileChooser::getFullPath(string& s) { s = path + "/" + dirFiles[selItem].name; }
